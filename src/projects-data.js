export const PROJECTS = [
  {
    id: "ra-albarokah",
    title: "PPDB Online RA Al Barokah",
    role: "Full Stack Developer",
    year: "2025",
    shortDesc: "Platform PPDB online yang mendigitalkan proses pendaftaran siswa baru dan manajemen administrasi sekolah secara terintegrasi.",
  ...
  {
    id: "kasir-pintar",
    title: "Web Kasir Pintar",
    role: "Full Stack Developer",
    year: "2024",
    shortDesc: "Aplikasi Point of Sale (POS) modern untuk otomatisasi transaksi, manajemen stok real-time, dan laporan keuangan bisnis UMKM.",
  ...
  {
    id: "mlm-mudapedia",
    title: "Sistem MLM PT Mudapedia",
    role: "Full Stack Developer",
    year: "2026",
    shortDesc: "Platform Multi Level Marketing (MLM) dengan arsitektur Next.js yang mengelola jaringan member, sistem poin, dan transaksi produk secara real-time.",
  ...
  {
    id: "spk-pemilihan",
    title: "SPK Pemilihan (Metode SAW)",
    role: "Full Stack Developer",
    year: "2025",
    shortDesc: "Aplikasi Sistem Pendukung Keputusan untuk penilaian pemilihan kandidat terbaik menggunakan metode Simple Additive Weighting (SAW).",
